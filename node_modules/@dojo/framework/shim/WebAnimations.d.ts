...
export declare type AnimationEffectTimingFillMode = 'none' | 'forwards' | 'backwards' | 'both' | 'auto';
export declare type AnimationEffectTimingPlaybackDirection = 'normal' | 'reverse' | 'alternate' | 'alternate-reverse';
export declare type AnimationPlayState = 'idle' | 'running' | 'paused' | 'finished';
...
export interface KeyframeEffectConstructor {
    ...
    new (target: HTMLElement, effect: AnimationKeyFrame | AnimationKeyFrame[], timing: number | AnimationEffectTiming, id?: string): KeyframeEffect;
}
export declare type AnimationEventListener = (this: Animation, evt: AnimationPlaybackEvent) => any;
...
export declare const Animation: AnimationConstructor;
export declare const KeyframeEffect: KeyframeEffectConstructor;
