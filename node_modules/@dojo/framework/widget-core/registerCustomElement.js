(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "./WidgetBase", "./vdom", "../shim/array", "./d", "../shim/global", "./mixins/Themed", "./decorators/alwaysRender"], factory);
    }
    ...
    function create(descriptor, WidgetConstructor) {
        ...
        return /** @class */ (function (_super) {
            ...
            class_1.prototype.connectedCallback = function () {
                ...
                var r = vdom_1.renderer(function () { return d_1.w(Wrapper, {}); });
                this._renderer = r;
                r.mount({ domNode: this, merge: false, registry: registry });
                var root = this.children[0];
                if (root) {
                    var _a = global_1.default.getComputedStyle(root).display, display = _a === void 0 ? 'block' : _a;
