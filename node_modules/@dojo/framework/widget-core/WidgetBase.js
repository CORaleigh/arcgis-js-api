(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../shim/Map", "../shim/WeakMap", "./d", "./diff", "./RegistryHandler", "./NodeHandler", "./Registry"], factory);
    }
    ...
    var WidgetBase = /** @class */ (function () {
        ...
        function WidgetBase() {
            ...
            exports.widgetInstanceMap.set(this, {
                dirty: true,
                onAttach: function () {
                    _this.onAttach();
                },
            ...
            this.own({
                destroy: function () {
                    exports.widgetInstanceMap.delete(_this);
        ...
        WidgetBase.prototype.__setProperties__ = function (originalProperties, bind) {
            var _this = this;
            var instanceData = exports.widgetInstanceMap.get(this);
            if (instanceData) {
            ...
            if (this._initialProperties === false || registeredDiffPropertyNames.length !== 0) {
                ...
                for (var i = 0; i < allProperties.length; i++) {
                    ...
                    var newProperty = this._bindFunctionProperty(properties[propertyName], bind);
        ...
        WidgetBase.prototype._filterAndConvert = function (nodes) {
            var isArray = Array.isArray(nodes);
            var filteredNodes = Array.isArray(nodes) ? nodes : [nodes];
            var convertedNodes = [];
            for (var i = 0; i < filteredNodes.length; i++) {
                ...
                if (d_1.isVNode(node) && node.deferredPropertiesCallback) {
                    var properties = node.deferredPropertiesCallback(false);
                    node.originalProperties = node.properties;
                    node.properties = tslib_1.__assign({}, properties, node.properties);
                }
                if (d_1.isWNode(node) && !Registry_1.isWidgetBaseConstructor(node.widgetConstructor)) {
                    if (typeof node.widgetConstructor === 'function') {
                        var id = lazyWidgetIdMap.get(node.widgetConstructor);
                        if (!id) {
                        ...
                        var _a = node.widgetConstructor, label = _a.label, registryItem = _a.registryItem;
        ...
        WidgetBase.prototype.__render__ = function () {
            ...
            var dNode = this._filterAndConvert(this._runAfterRenders(render()));
