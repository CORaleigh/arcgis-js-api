import { Constructor, DefaultWidgetBaseInterface, DeferredVirtualProperties, DNode, VNode, RegistryLabel, VNodeProperties, WidgetBaseInterface, WNode, DomOptions, RenderResult, DomVNode, LazyWidget, LazyDefine } from './interfaces';
/**
 * The identifier for a WNode type
 */
export declare const WNODE = "__WNODE_TYPE";
/**
 * The identifier for a VNode type
 */
export declare const VNODE = "__VNODE_TYPE";
/**
 * The identifier for a VNode type created using dom()
 */
export declare const DOMVNODE = "__DOMVNODE_TYPE";
/**
 * Helper function that returns true if the `DNode` is a `WNode` using the `type` property
 */
export declare function isWNode<W extends WidgetBaseInterface = DefaultWidgetBaseInterface>(child: DNode<W> | any): child is WNode<W>;
/**
 ...
 */
export declare function w<W extends WidgetBaseInterface>(node: WNode<W>, properties: Partial<W['properties']>, children?: W['children']): WNode<W>;
export declare function w<W extends WidgetBaseInterface>(widgetConstructor: Constructor<W> | RegistryLabel | LazyWidget<W> | LazyDefine<W>, properties: W['properties'], children?: W['children']): WNode<W>;
/**
