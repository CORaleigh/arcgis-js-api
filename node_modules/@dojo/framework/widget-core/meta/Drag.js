(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../../core/util", "../../shim/global", "../../shim/object", "../../shim/WeakMap", "./Base"], factory);
    }
    ...
    function createNodeData(invalidate) {
        return {
            dragResults: util_1.deepAssign({}, emptyResults),
        ...
        function DragController() {
            ...
            this._onDragStart = function (event) {
                ...
                if (data) {
                    ...
                    state.dragResults.start = util_1.deepAssign({}, state.start);
