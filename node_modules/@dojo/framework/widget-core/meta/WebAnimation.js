(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "./Base", "../../shim/Map", "../../shim/global", "../../shim/WebAnimations"], factory);
    }
    ...
    var WebAnimations_1 = require("../../shim/WebAnimations");
    var WebAnimations = /** @class */ (function (_super) {
        ...
        WebAnimations.prototype._createPlayer = function (node, properties) {
            ...
            var keyframeEffect = new WebAnimations_1.KeyframeEffect(node, fx, timing);
            return new WebAnimations_1.Animation(keyframeEffect, global_1.default.document.timeline);
        };
