(function (factory) {
    ...
    var HistoryManager = /** @class */ (function () {
        function HistoryManager() {
            ...
            this.after = function (error, result) {
            ...
            this.callback = function () { return ({ after: _this.after }); };
        }
        ...
        HistoryManager.prototype.deserialize = function (store, data) {
            ...
            history.forEach(function (_a) {
                ...
                process_1.processExecutor(id, [function () { return operations; }], store, before, after, undefined)({});
            });
            var stacks = this._storeMap.get(store);
