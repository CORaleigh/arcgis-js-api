...
define(["require", "exports", "esri/core/tsSupport/declareExtendsHelper", "esri/core/tsSupport/decorateHelper", "dojo/i18n!esri/widgets/Sketch/nls/Sketch", "esri/core/Collection", "esri/core/lang", "esri/core/accessorSupport/decorators", "esri/widgets/Widget", "esri/widgets/ColorPicker", "esri/widgets/Sketch/SketchViewModel", "esri/Color", "esri/widgets/support/widget"], function (require, exports, __extends, __decorate, i18n, Collection, lang_1, decorators_1, Widget, ColorPicker, SketchViewModel, Color, widget_1) {
    "use strict";
    ...
    var Sketch = /** @class */ (function (_super) {
        ...
        function Sketch(params) {
            ...
            _this._fillColor = new Color("rgba(255,0,0,0.5)");
            _this._outlineColor = new Color("rgba(255,255,255,1)");
            _this._fillSelected = false;
            _this._outlineSelected = false;
            return _this;
        }
        ...
        Sketch.prototype.render = function () {
            ...
            if (this._rendered) {
                if (!this._fillpicker) {
                    ...
                    this._fillpicker.watch('color', function (color) {
                        if (color) {
                            rgba_1 = 'rgba(' + color.r + ',' + color.g + ',' + color.b + ',' + color.a + ')';
                            _this._fillColor = new Color(rgba_1);
                        }
                        else {
                            _this._fillColor.a = 0;
                        }
                        document.getElementById('fill-button').style.backgroundColor = rgba_1;
                        if (_this.updateGraphics.length) {
                            _this.updateGraphics.forEach(function (graphic) {
                                if (graphic.geometry.type === 'point') {
                                    _this._changePointSymbol(graphic);
                                }
                                if (graphic.geometry.type === 'polygon') {
                                    _this._changeFillSymbol(graphic);
                                }
                                if (graphic.geometry.type === 'polyline') {
                                    _this._changeLineSymbol(graphic);
                                }
                            });
                        }
                    });
                ...
                if (!this._outlinepicker) {
                    ...
                    this._outlinepicker.watch('color', function (color) {
                        if (color) {
                            rgba_2 = 'rgba(' + color.r + ',' + color.g + ',' + color.b + ',' + color.a + ')';
                            _this._outlineColor = new Color(rgba_2);
                        }
                        else {
                            _this._outlineColor.a = 0;
                        }
                        document.getElementById('outline-button').style.backgroundColor = rgba_2;
                        if (_this.updateGraphics.length) {
                            _this.updateGraphics.forEach(function (graphic) {
                                if (graphic.geometry.type === 'point') {
                                    _this._changePointSymbol(graphic);
            ...
            return (widget_1.tsx("div", { "aria-label": i18n.widgetLabel, class: classes },
                ...
                widget_1.tsx("div", { class: this.classes(CSS.section) }, this.renderFillButton()),
                widget_1.tsx("div", { class: this.classes(CSS.section) }, this.renderOutlineButton())));
        };
        Sketch.prototype.renderTopPanelContents = function () {
            return [
                widget_1.tsx("div", { class: this.classes(CSS.section, CSS.toolSection) }, this.renderNavigationButtons()),
                widget_1.tsx("div", { class: this.classes(CSS.section, CSS.toolSection) }, this.renderDrawButtons()),
                widget_1.tsx("div", { class: this.classes(CSS.section, CSS.toolSection) }, this.renderMenuButtons())
            ];
        };
        ...
        Sketch.prototype.renderFillButton = function () {
            ...
            return (widget_1.tsx("div", null,
                widget_1.tsx("button", { 
                    // disabled={isDisabled}
                    id: "fill-button", key: "fill-button", class: this.classes(CSS.esriButton), bind: this, onclick: this._showFillColor, title: "Fill Color", "aria-label": "Fill Color" }, "Fill Color"),
                widget_1.tsx("div", { id: "fill-section", key: "fill-section", class: this.classes(classes) },
                    widget_1.tsx("div", { id: "fillColor", key: "fillColor", bind: this }))));
        };
        Sketch.prototype.renderOutlineButton = function () {
            var classes = [];
            if (this._outlineSelected) {
                classes.push(CSS.colorVisible);
            }
            ...
            return (widget_1.tsx("div", null,
                widget_1.tsx("button", { 
                    // disabled={isDisabled}
                    id: "outline-button", key: "outline-button", class: this.classes(CSS.esriButton), bind: this, onclick: this._showOutlineColor, title: "Outline Color", "aria-label": "Outline Color" }, "Outline Color"),
                widget_1.tsx("div", { id: "outline-section", key: "outline-section", class: this.classes(classes) },
                    widget_1.tsx("div", { id: "outlineColor", key: "outlineColor", bind: this }))));
        };
        //--------------------------------------------------------------------------
        //
        //  Private Methods
        ...
        Sketch.prototype._changePointSymbol = function (graphic) {
            graphic.symbol = {
                type: "simple-marker",
        ...
        Sketch.prototype._changeFillSymbol = function (graphic) {
            graphic.symbol = {
                type: "simple-fill",
                color: new Color(this._fillColor),
                style: "solid",
        ...
        Sketch.prototype._changeLineSymbol = function (graphic) {
            graphic.symbol = {
                type: "simple-line",
                color: new Color(this._outlineColor),
                style: "solid",
